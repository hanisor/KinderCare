...
class _CaregiverSicknessState extends State<CaregiverSickness> {
    ...
    if (response != null && response['child_group'] is List) {
      ...
      for (var childGroup in childGroupList) {
        ...
        if (child != null && child['sicknesses'] is List) {
          ...
          for (var sickness in sicknessesList) {
            ...
            if (sicknessDate.year == now.year &&
                sicknessDate.month == now.month &&
                sicknessDate.day == now.day) {
              setState(() {
      ...
      checklistItems.sort((a, b) {
        if (a.sicknessStatus == 'Pending' && b.sicknessStatus == 'Taken') {
          return -1;
        } else if (a.sicknessStatus == 'Taken' &&
            b.sicknessStatus == 'Pending') {
          return 1;
        }
        return 0;
      });
  ...
  Future<void> updateSicknessStatus(int? sicknessId, bool isTaken) async {
                    ...
                    child: ListTile(
                      title: RichText(
                        text: TextSpan(
                          ...
                          children: <TextSpan>[
                            ...
                            TextSpan(
                              text:
                                  '${item.childModel?.childName ?? "Unknown"}',
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          Text(
                              'Date and Time: ${_formatDateTime(item.dateTime)}'),
                      ...
                      trailing: Checkbox(
                        ...
                        onChanged: (bool? value) {
                          ...
                          updateSicknessStatus(item.sicknessId, value!);
                        },
                      ),
                    ),
                  );
